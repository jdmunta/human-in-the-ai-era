...
export async function getStaticPaths() {
  ...
  const pages = [
    { slug: 'default', eyebrow: 'A working argument · twelve essays',
    ...
    { slug: 'playbook', eyebrow: 'The Playbook · 53 practices',
      title: 'Everything the essays ask you to do',
      blurb: 'Every practice from all twelve essays in one filterable list, by cadence and by topic.' },
    ...
    { slug: 'reflect', eyebrow: 'Private · 59 questions',
    ...
    { slug: 'glossary', eyebrow: 'Reference · 27 terms',
