...
export async function getStaticPaths() {
  ...
  const pages = [
    { slug: 'default', eyebrow: 'A working argument · fourteen essays',
    ...
    { slug: 'playbook', eyebrow: 'The Playbook · 64 practices',
      title: 'Everything the essays ask you to do',
      blurb: 'Every practice from all fourteen essays in one filterable list, by cadence and by topic.' },
    ...
    { slug: 'changelog', eyebrow: 'Revision history',
      title: 'What has actually changed',
      blurb: 'Generated from the repository commit history rather than asserted — every entry is a commit you can read.' },
    { slug: 'journal', eyebrow: 'Private · unassisted',
      title: 'The journal',
      blurb: 'A different question every day, kept in your browser, with nothing on the page offering to write it for you.' },
    ...
    { slug: 'read', eyebrow: 'Single page · fourteen essays',
    ...
    { slug: 'reflect', eyebrow: 'Private · 69 questions',
    ...
    { slug: 'glossary', eyebrow: 'Reference · 30 terms',
