...
export async function GET() {
  ...
  const pages = [
    ...
    { slug: 'map', title: 'The argument map', kicker: 'Reference',
      summary: 'How the fourteen essays depend on each other: which claim is load-bearing for which.', path: '/map' },
    { slug: 'read', title: 'The whole argument', kicker: 'Reference',
      summary: 'All fourteen essays on a single page, for reading offline, printing or saving as a PDF.', path: '/read' },
    ...
    { slug: 'playbook', title: 'The Playbook', kicker: 'Tool',
      summary: 'Every practice from all fourteen essays, filterable.', path: '/playbook' },
